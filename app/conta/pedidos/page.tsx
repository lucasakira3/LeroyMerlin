      ...
      {pedidos !== null && pedidos.length > 0 && (
        <div className="space-y-3">
          {pedidosPaginados.map(pedido => {
            ...
            return (
              <div key={pedido.numero} className="bg-white rounded-card shadow-soft border border-gray-500 p-4">
                ...
                <div className="flex items-center justify-end pt-2 border-t border-gray-500">
                ...
                <div className="flex items-center gap-3 pt-2 mt-2 border-t border-gray-500">
                  <button
                    type="button"
