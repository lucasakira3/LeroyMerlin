      ...
      <div className="flex gap-2 mb-4">
        <button
          ...
          className={`flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-xl transition-colors ${
            modo === 'agendamentos' ? 'bg-lm-green text-white' : 'bg-white text-gray-600 border border-gray-200 hover:border-lm-green/40'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-xl transition-colors ${
            modo === 'conversas' ? 'bg-lm-green text-white' : 'bg-white text-gray-600 border border-gray-200 hover:border-lm-green/40'
          }`}
        >
