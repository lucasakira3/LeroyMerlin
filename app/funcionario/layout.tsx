...
export default function FuncionarioLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside
        className={`w-64 bg-white border-r border-gray-500 flex flex-col shadow-sm z-40 fixed inset-y-0 left-0 transition-transform duration-300 ease-out lg:static lg:translate-x-0 lg:shadow-sm ${
          sidebarAberta ? 'translate-x-0 shadow-soft-lg' : '-translate-x-full'
        }`}
      >
        <div className="p-6 flex items-center justify-between border-b border-gray-500 bg-white">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden flex items-center justify-between px-4 h-14 bg-white border-b border-gray-500 flex-shrink-0 z-20">
          <button
            type="button"
