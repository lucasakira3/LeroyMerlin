...
export default function ComparadorFerramenta() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full min-h-0">
      {/* Seletor de produtos */}
      <div className="md:w-72 flex-shrink-0 flex flex-col border-b md:border-b-0 md:border-r border-gray-100 dark:border-zinc-800 p-4 gap-3 max-h-[45vh] md:max-h-none">
