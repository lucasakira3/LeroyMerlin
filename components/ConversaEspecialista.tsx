      ...
      <div className="border-t border-gray-500 p-4">
        <form onSubmit={e => { e.preventDefault(); enviar() }} className="flex gap-2">
          <input
            ...
            className="flex-1 h-11 px-4 rounded-xl border border-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-lm-green focus:border-transparent bg-white"
          />
          <button
            type="submit"
            disabled={!input.trim()}
