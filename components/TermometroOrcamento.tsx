...
export default function TermometroOrcamento() {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border border-gray-500 dark:border-zinc-800 rounded-card shadow-soft">
        ...
        {editando || orcamento === null ? (
          ...
          >
            ...
            <input
              ...
              placeholder="ex: 500"
              className="w-24 h-8 px-2 rounded-lg border border-gray-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 text-sm focus:outline-none focus:ring-2 focus:ring-lm-green/30"
            />
        ...
        <div className="px-4 pb-3 flex items-center gap-3 text-xs">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <img
              ...
              alt=""
              className={`w-8 h-8 rounded-lg ${ajusteFoto(sugestao.itemAtual, 'p-0.5')} opacity-60`}
            />
