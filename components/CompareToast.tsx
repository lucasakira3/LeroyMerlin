...
export default function CompareToast() {
  ...
  return (
    ...
    >
      <div className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md border border-gray-200 dark:border-zinc-800 shadow-soft-lg rounded-2xl p-5 relative overflow-hidden" style={{ boxShadow: '0 12px 40px -4px rgba(0, 0, 0, 0.12)' }}>
