  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center justify-center w-9 h-9 rounded-lg border border-gray-500 text-gray-500 hover:bg-gray-50 hover:border-lm-green/40 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent transition-colors"
      >
        <ChevronLeft size={16} />
      </button>
          ...
          <button
            ...
            className={`w-9 h-9 rounded-lg text-sm font-semibold transition-colors ${
              p === page
                ...
                : 'text-gray-600 border border-gray-500 hover:bg-gray-50 hover:border-lm-green/40'
            }`}
          >
            {p}
          </button>
