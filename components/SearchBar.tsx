    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full h-14 pl-12 pr-14 rounded-xl border border-gray-500 bg-white text-lm-dark placeholder-gray-400 text-base shadow-soft focus:outline-none focus:ring-2 focus:ring-lm-green/30 focus:border-transparent disabled:opacity-60 disabled:cursor-not-allowed"
        />
