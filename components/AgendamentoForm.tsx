                ...
                <button
                  ...
                  className={`flex items-start gap-3 text-left p-3 rounded-xl border transition-all ${
                    form.servico === s.id
                      ...
                      : 'border-gray-500 bg-white hover:border-lm-green/40'
                  }`}
                >
      ...
      {step === 2 && (
        <div className="space-y-6">
          ...
          <div className="flex gap-3">
            <Button variant="ghost" onClick={() => setStep(1)} className="flex-1 h-12 border border-gray-500">
              Voltar
            </Button>
            <Button
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 rounded-xl border border-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-lm-green/30 resize-none bg-white"
            />
          </div>
          ...
          <div className="flex gap-3">
            <Button variant="ghost" onClick={() => setStep(2)} className="flex-1 h-12 border border-gray-500">
              Voltar
            </Button>
            <Button
