...
export default function CalculadoraMateriais() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full min-h-0">
      {/* Formulário */}
      <div className="md:w-72 flex-shrink-0 flex flex-col border-b md:border-b-0 md:border-r border-gray-200 dark:border-zinc-800 p-4 gap-3">
            ...
            {!buscandoProdutos && (
              <div className="space-y-1.5">
                {produtos?.map(produto => (
                  <div
                    key={produto.id}
                    className="flex items-center gap-2.5 px-3 py-2 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-xs"
                  >
                    <img
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full h-9 mt-1 px-3 rounded-lg border border-gray-200 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 text-sm focus:outline-none focus:ring-2 focus:ring-lm-green/30"
      />
    </label>
  )
}
