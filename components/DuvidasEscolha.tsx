        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {OPCOES.map(({ modo, titulo, descricao, icone: Icone }) => (
            <button
              ...
              className="flex flex-col items-start gap-4 bg-white border-2 border-gray-200 rounded-3xl p-10 text-left hover:border-lm-green/40 hover:shadow-soft-lg transition-all"
            >
