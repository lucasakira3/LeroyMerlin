...
export default function NotificacoesBell() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {aberto && (
        <div className="absolute left-0 md:left-auto md:right-0 top-full mt-2 w-80 max-w-[calc(100vw-2rem)] max-h-96 overflow-y-auto bg-white rounded-xl shadow-lg border border-gray-200 z-50">
              ...
              {notificacoes.map((n) => (
                <li key={n.id}>
                  <Link
                    ...
                    className={`flex items-start gap-2 px-4 py-3 border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition-colors ${
