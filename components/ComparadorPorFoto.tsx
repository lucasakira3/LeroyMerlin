...
export default function ComparadorPorFoto() {
  ...
  if (!aberto) {
    return (
      <button
        ...
        className="flex items-center gap-1.5 text-xs font-semibold text-gray-500 dark:text-zinc-400 border border-gray-500 dark:border-zinc-700 px-3 py-1.5 rounded-full hover:border-lm-green/40 hover:text-lm-green transition-colors flex-shrink-0"
      >
  ...
  return (
    <div className="w-full bg-white dark:bg-zinc-900 border border-gray-500 dark:border-zinc-700 rounded-xl p-3 animate-fade-in">
      ...
      {!preview ? (
        ...
        <div className="relative rounded-lg overflow-hidden border border-gray-500 dark:border-zinc-700 mb-2">
