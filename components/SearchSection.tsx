    ...
    <div ref={sectionRef} className="space-y-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="flex-1 h-9 px-3 rounded-xl border border-gray-400 text-sm text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-lm-green/30"
        >
      ...
      {loading && (
        <div className="space-y-4 animate-fade-in">
          <div className="flex items-center gap-2 p-3 bg-white border border-gray-400 rounded-xl shadow-soft">
        ...
        <div className="text-center py-12">
          ...
          <div className="flex flex-wrap gap-2.5 justify-center">
            {['Torneira banheiro', 'Tinta branca', 'Disjuntor 20A', 'Piso laminado', 'Mangueira jardim'].map((s) => (
              <span key={s} className="px-3 py-1.5 bg-white border border-gray-400 shadow-soft rounded-full text-sm text-gray-600">
                {s}
              </span>
            ))}
          </div>
